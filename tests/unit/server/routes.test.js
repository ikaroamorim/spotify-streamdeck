...
describe('#Routes - test site for api response', () => {
   ...
   test(`GET /home - should respond with ${pages.homeHTML} filestream`, async () => {
      const params = TestUtil.defaultHandleParams()
      params.request.method = 'GET'
   ...
   test(`GET /controller - should respont with ${pages.controllerHTML} filestream`, async () => {
      const params = TestUtil.defaultHandleParams()
      params.request.method = 'GET'
   ...
   test(`GET /unknown - given a inexistent route it should respond with 404`, async () => {
      const params = TestUtil.defaultHandleParams()
   ...
   describe('exceptions', () => {
      test('given a inexistent file it should respond with 404', async () => {
         const params = TestUtil.defaultHandleParams()
         params.request.method = 'GET'
         ...
         jest.spyOn(
            Controller.prototype,
            Controller.prototype.getFileStream.name
         ).mockRejectedValue(new Error('Error: ENOENT: no such file or string'))
